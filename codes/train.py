...
def pretrain(mixpoet, tool, hps):
    ...
    print("classifier3 pretraining...")
    cl_trainer.train(mixpoet, tool, factor_id=3)
    print("classifier3 pretraining done!")

    print("classifier4 pretraining...")
    cl_trainer.train(mixpoet, tool, factor_id=4)
    print("classifier4 pretraining done!")

    print("classifier5 pretraining...")
    cl_trainer.train(mixpoet, tool, factor_id=5)
    print("classifier5 pretraining done!")
    # --------------------------------------
