...
from PyQt5.QtWidgets import (
    QApplication, QWidget, QVBoxLayout, QFormLayout, QLabel, QLineEdit, QRadioButton, QButtonGroup, QPushButton,
    QTextEdit, QCheckBox
)
...
class PoetryGeneratorUI(QWidget):
    def __init__(self):
        ...
        self.setFixedSize(800, 800)  # 固定窗口大小
        ...
        self.manu_checkbox = QCheckBox("手动选择句子")
        form_layout.addRow(self.manu_checkbox)
    ...
    def generate_poem(self):
        ...
        manu = self.manu_checkbox.isChecked()

        try:
            lines, info = self.generator.generate_one(keyword, length, *labels, beam_size=20, verbose=1, manu=manu)
            if lines:
                poem = "\n".join(lines)
