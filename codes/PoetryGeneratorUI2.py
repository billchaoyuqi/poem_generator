...
from PyQt5.QtWidgets import (
    QApplication, QWidget, QVBoxLayout, QFormLayout, QLabel, QLineEdit, QRadioButton, QButtonGroup, QPushButton, QMessageBox
)
    ...
    def generate_poem(self):
        ...
        try:
            ...
            if lines:
                poem = "\n".join(lines)
                msg_box = QMessageBox()
                msg_box.setFixedSize(600, 450)  # 固定弹窗大小
                msg_box.setWindowTitle("生成的诗歌")
                msg_box.setText(f"生成的诗歌为：\n{poem}")
                msg_box.exec_()
            else:
