...
HParams = namedtuple('HParams',
                     ...
                     # emb_size, hidden_size, context_size, latent_size: 嵌入层大小，隐藏层大小，上下文向量
                     'emb_size, hidden_size, context_size, latent_size, factor_emb_size,'
                     'n_class1, n_class2, n_class3, n_class4, n_class5, '
                     'key_len, sens_num, sen_len, poem_len,'
...
hparams = HParams(
    ...
    # factor3, if_number
    #   0: yes, 1: no
    # factor4, if_top_needle
    #   0: yes, 1: no
    # factor5, if_tiangan_dizhi
    #   0: yes, 1: no
    n_class1=3, n_class2=2, n_class3=2, n_class4=2, n_class5=2,
    ...
    train_data="../corpus/semi_train_2.0.pickle",
    valid_data="../corpus/semi_valid_2.0.pickle",
